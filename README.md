...
|----------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------|----------|
| SCANOSS_CLI_DOCKER_IMAGE   | SCANOSS CLI Docker Image.                                                                                                                                                | [https://ghcr.io/scanoss/scanoss-py-jenkins:v1.46.0](https://github.com/scanoss/scanoss.py/releases/tag/v1.46.0) | Pipeline |
